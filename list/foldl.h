...
#define LIST_FOLDL(F,X,...) _LIST_FOLDL_EVAL(_LIST_FOLDL(F,LIST_IS_NIL(X),_LIST_FOLDL_P ## __VA_OPT__(1)(X),_LIST_FOLDL_INIT ## __VA_OPT__(1(__VA_ARGS__) IGNORE) (X)))
...
#define _LIST_FOLDL(F,N,X,R) DEFER(CAT(_LIST_FOLDL_X, N))(F,X,R)
