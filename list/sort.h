...
#define _LIST_SORT(LT,X,R) DEFER(CAT(_LIST_SORT_X, LIST_IS_NIL(X)))(LT,X,R)
#define _LIST_SORT_X1(LT,X,R) R
#define _LIST_SORT_X0(LT,X,R) _LIST_SORT_Y(LT,LIST_FIRST(X),LIST_REST(X),LIST_NIL,R)
#define _LIST_SORT_Y(LT,E,X,Y,R) DEFER(CAT(_LIST_SORT_Z, LIST_IS_NIL(X)))(LT,E,X,Y,R)
#define _LIST_SORT_Z1(LT,E,X,Y,R) DEFER(_LIST_SORT_I)()(LT,Y,(E,R))
#define _LIST_SORT_Z0(LT,E,X,Y,R) DEFER(CAT(_LIST_SORT_W, LT(E,LIST_FIRST(X))))(LT,E,LIST_FIRST(X),LIST_REST(X),Y,R)
