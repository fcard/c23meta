...
#define TUPLE_SPLIT_ALL(P,X) _TUPLE_SPLIT_ALL_EVAL(_TUPLE_SPLIT_ALL(P,(),(),TUPLE_IS_EMPTY(X),X))
...
#define _TUPLE_SPLIT_ALL(P,R,RF,N,X) DEFER(CAT(_TUPLE_SPLIT_ALL_X, N))(P,R,RF,X)
#define _TUPLE_SPLIT_ALL_X1(P,R,RF,X) TUPLE_PUSH(RF,R)
#define _TUPLE_SPLIT_ALL_X0(P,R,RF,X) DEFER(CAT(_TUPLE_SPLIT_ALL_Y,P(TUPLE_FIRST(X))))(P,R,RF,X)
