...
#define TUPLE_FLATTEN(X) _TUPLE_FLATTEN_C(X)
#define _TUPLE_FLATTEN_C(X) _TUPLE_FLATTEN_EVALX(_TUPLE_REST _TUPLE_FLATTEN_EVAL((_TUPLE_FLATTEN(X,LIST_NIL))))
...
#define _TUPLE_FLATTEN_X1(X,L) CAT(_TUPLE_FLATTEN_Z,LIST_IS_NIL(L))(L)
#define _TUPLE_FLATTEN_X0(X,L) CAT(_TUPLE_FLATTEN_Y,IS_TUPLE(TUPLE_FIRST(X)))(X,L)
