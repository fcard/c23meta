...
#define TUPLE_SPLIT(P,X) _TUPLE_SPLIT_C(P,X)
#define _TUPLE_SPLIT_C(P,X) _TUPLE_SPLIT_EVAL(_TUPLE_SPLIT(P,(),TUPLE_IS_EMPTY(X),X))
...
#define _TUPLE_SPLIT(P,R,N,X) CAT(_TUPLE_SPLIT_X, N)(P,R,X)
#define _TUPLE_SPLIT_X1(P,R,X) (R,())
#define _TUPLE_SPLIT_X0(P,R,X) CAT(_TUPLE_SPLIT_Y,P(TUPLE_FIRST(X)))(P,R,X)
