...
#define _TUPLE_SORT(LT,X,R) DEFER(CAT(_TUPLE_SORT_X, TUPLE_IS_EMPTY(X)))(LT,X,R)
#define _TUPLE_SORT_X1(LT,X,R) R
#define _TUPLE_SORT_X0(LT,X,R) _TUPLE_SORT_Y(LT,TUPLE_FIRST(X),TUPLE_REST(X),(),R)
#define _TUPLE_SORT_Y(LT,E,X,Y,R) DEFER(CAT(_TUPLE_SORT_Z, TUPLE_IS_EMPTY(X)))(LT,E,X,Y,R)
#define _TUPLE_SORT_Z1(LT,E,X,Y,R) DEFER(_TUPLE_SORT_I)()(LT,Y,TUPLE_PUSH(R,E))
#define _TUPLE_SORT_Z0(LT,E,X,Y,R) DEFER(CAT(_TUPLE_SORT_W, LT(TUPLE_FIRST(X),E)))(LT,E,TUPLE_FIRST(X),TUPLE_REST(X),Y,R)
