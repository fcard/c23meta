...
#define TUPLE_MAP2(F,X,Y) _TUPLE_MAP2_EVAL((_TUPLE_MAP2(F,TUPLE_IS_EMPTY(X),TUPLE_IS_EMPTY(Y),X,Y)))
...
#define _TUPLE_MAP2(F,NX,NY,X,Y) DEFER(CAT(CAT(_TUPLE_MAP2_X,NX),NY))(F,X,Y)
...
#define _TUPLE_MAP2_COMMA(X,Y) DEFER(CAT(CAT(_TUPLE_MAP2_COMMA_X,TUPLE_IS_EMPTY(TUPLE_REST(X))),TUPLE_IS_EMPTY(TUPLE_REST(Y))))()
