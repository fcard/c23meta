...
#define TUPLE_EVERY(P,X) _TUPLE_EVERY_C(P,X)
#define _TUPLE_EVERY_C(P,X) _TUPLE_EVERY_EVAL(_TUPLE_EVERY(P,TUPLE_IS_EMPTY(X),X))
...
#define _TUPLE_EVERY(P,N,X) CAT(_TUPLE_EVERY_X, N)(P,X)
#define _TUPLE_EVERY_X1(P,X) 1
#define _TUPLE_EVERY_X0(P,X) CAT(_TUPLE_EVERY_Y,P(TUPLE_FIRST(X)))(P,X)
