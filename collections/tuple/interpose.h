...
#define TUPLE_INTERPOSE(X,S) _TUPLE_INTERPOSE_EVAL((_TUPLE_INTERPOSE(TUPLE_IS_EMPTY(X),X,S)))
...
#define _TUPLE_INTERPOSE(N,X,S) DEFER(CAT(_TUPLE_INTERPOSE_X, N))(X,S)
#define _TUPLE_INTERPOSE_X1(X,S)
#define _TUPLE_INTERPOSE_X0(X,S) DEFER(CAT(_TUPLE_INTERPOSE_Y,TUPLE_IS_EMPTY(TUPLE_REST(X))))(X,S)
