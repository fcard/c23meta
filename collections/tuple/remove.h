...
#define TUPLE_REMOVE(P,X) TUPLE_REST(_TUPLE_REMOVE_EVAL((_TUPLE_REMOVE(P,TUPLE_IS_EMPTY(X),X))))
...
#define _TUPLE_REMOVE(P,N,X) DEFER(CAT(_TUPLE_REMOVE_X, N))(P,X)
#define _TUPLE_REMOVE_X1(P,X)
#define _TUPLE_REMOVE_X0(P,X) DEFER(CAT(_TUPLE_REMOVE_Y,P(TUPLE_FIRST(X))))(P,X)
