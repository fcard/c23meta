...
#define TUPLE_DROP_WHILE(P,X) _TUPLE_DROP_WHILE_C(P,X)
#define _TUPLE_DROP_WHILE_C(P,X) _TUPLE_DROP_WHILE_EVAL(_TUPLE_DROP_WHILE(P,TUPLE_IS_EMPTY(X),X))
...
#define _TUPLE_DROP_WHILE(P,N,X) CAT(_TUPLE_DROP_WHILE_X, N)(P,X)
#define _TUPLE_DROP_WHILE_X1(P,X)
#define _TUPLE_DROP_WHILE_X0(P,X) CAT(_TUPLE_DROP_WHILE_Y,P(TUPLE_FIRST(X)))(P,X)
