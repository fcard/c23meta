...
#define _TUPLE_LENGTH_C(X) _TUPLE_LENGTH_EVAL(DEFER(_TUPLE_LENGTH) (U32H_0 COMMA_IF X UNWRAP X))
...
#define _TUPLE_LENGTH_X1(N,X,...) DEFER(_TUPLE_LENGTH_I)()(U32H_ADD(N,U32H_1) __VA_OPT__(,) __VA_ARGS__)
