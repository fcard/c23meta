...
#define TUPLE_FOLDL(F,X,...) _TUPLE_FOLDL_C(F,X __VA_OPT__(,) __VA_ARGS__)
#define _TUPLE_FOLDL_C(F,X,...) _TUPLE_FOLDL_EVAL(_TUPLE_FOLDL(F,TUPLE_IS_EMPTY(X),_TUPLE_FOLDL_P ## __VA_OPT__(1)(X),_TUPLE_FOLDL_INIT ## __VA_OPT__(1(__VA_ARGS__) IGNORE) (X)))
...
#define _TUPLE_FOLDL(F,N,X,R) CAT(_TUPLE_FOLDL_X, N)(F,X,R)
