...
#define TUPLE_INSERT(X,E,N) TUPLE_REST(_TUPLE_INSERT_EVAL((_TUPLE_INSERT(TUPLE_IS_EMPTY(X),X,E,N))))
...
#define _TUPLE_INSERT(NX,X,E,N) DEFER(CAT(_TUPLE_INSERT_X, NX))(X,E,N)
#define _TUPLE_INSERT_X1(X,E,N)
#define _TUPLE_INSERT_X0(X,E,N) DEFER(CAT(_TUPLE_INSERT_Y,U32_EQ(N,U32_0)))(X,E,N)
#define _TUPLE_INSERT_Y1(X,E,N) ,UNWRAP(E)UNWRAP(COMMA_IF X)UNWRAP X
#define _TUPLE_INSERT_Y0(X,E,N) ,TUPLE_FIRST(X)_TUPLE_INSERT_Z(TUPLE_REST(X),E,U32_SUB(N,U32_1))
