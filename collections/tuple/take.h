...
#define TUPLE_TAKE(X,N) TUPLE_REST(_TUPLE_TAKE_EVAL((_TUPLE_TAKE(TUPLE_IS_EMPTY(X),X,N))))
...
#define _TUPLE_TAKE(NX,X,N) DEFER(CAT(_TUPLE_TAKE_X, NX))(X,N)
#define _TUPLE_TAKE_X1(X,N) 
#define _TUPLE_TAKE_X0(X,N) DEFER(CAT(_TUPLE_TAKE_Y,U32_EQ(N,U32_0)))(X,N)
