...
#define TUPLE_TAKE_WHILE(P,X) TUPLE_REST(_TUPLE_TAKE_WHILE_EVAL((_TUPLE_TAKE_WHILE(P,TUPLE_IS_EMPTY(X),X))))
...
#define _TUPLE_TAKE_WHILE(P,N,X) DEFER(CAT(_TUPLE_TAKE_WHILE_X, N))(P,X)
#define _TUPLE_TAKE_WHILE_X1(P,X)
#define _TUPLE_TAKE_WHILE_X0(P,X) DEFER(CAT(_TUPLE_TAKE_WHILE_Y,P(TUPLE_FIRST(X))))(P,X)
