...
#define TUPLE_FIND_FIRST(P,X) _TUPLE_FIND_FIRST_EVAL(_TUPLE_FIND_FIRST(P,TUPLE_IS_EMPTY(X),X))
...
#define _TUPLE_FIND_FIRST(P,N,X) DEFER(CAT(_TUPLE_FIND_FIRST_X, N))(P,X)
#define _TUPLE_FIND_FIRST_X1(P,X) ()
#define _TUPLE_FIND_FIRST_X0(P,X) DEFER(CAT(_TUPLE_FIND_FIRST_Y,P(TUPLE_FIRST(X))))(P,X)
