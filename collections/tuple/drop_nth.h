...
#define TUPLE_DROP_NTH(X,N) TUPLE_REST(_TUPLE_DROP_NTH_EVAL((_TUPLE_DROP_NTH_PREAMBLE(U32H_EQ(N,U32H_0),X,N))))
...
#define _TUPLE_DROP_NTH_PREAMBLE(G,X,N) CAT(_TUPLE_DROP_NTH_P, G)(X,N)
#define _TUPLE_DROP_NTH_P0(X,N)  _TUPLE_DROP_NTH(TUPLE_IS_EMPTY(X),X,N,N)
#define _TUPLE_DROP_NTH_P1(X,N)

#define _TUPLE_DROP_NTH(NX,X,N0,N) CAT(_TUPLE_DROP_NTH_X, NX)(X,N0,N)
#define _TUPLE_DROP_NTH_X1(X,N0,N)
#define _TUPLE_DROP_NTH_X0(X,N0,N) CAT(_TUPLE_DROP_NTH_Y,U32H_EQ(N,U32H_1))(X,N0,N)
#define _TUPLE_DROP_NTH_Y1(X,N0,N) _TUPLE_DROP_NTH_Z(TUPLE_REST(X),N0,N0)
#define _TUPLE_DROP_NTH_Y0(X,N0,N) ,TUPLE_FIRST(X)_TUPLE_DROP_NTH_Z(TUPLE_REST(X),N0,U32H_SUB(N,U32H_1))
