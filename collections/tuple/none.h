...
#define TUPLE_NONE(P,X) _TUPLE_NONE_C(P,X)
#define _TUPLE_NONE_C(P,X) _TUPLE_NONE_EVAL(_TUPLE_NONE(P,TUPLE_IS_EMPTY(X),X))
...
#define _TUPLE_NONE(P,N,X) CAT(_TUPLE_NONE_X, N)(P,X)
#define _TUPLE_NONE_X1(P,X) 1
#define _TUPLE_NONE_X0(P,X) CAT(_TUPLE_NONE_Y,P(TUPLE_FIRST(X)))(P,X)
