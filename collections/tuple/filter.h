...
#define TUPLE_FILTER(P,X) TUPLE_REST(_TUPLE_FILTER_EVAL((_TUPLE_FILTER(P,TUPLE_IS_EMPTY(X),X))))
...
#define _TUPLE_FILTER(P,N,X) DEFER(CAT(_TUPLE_FILTER_X, N))(P,X)
#define _TUPLE_FILTER_X1(P,X)
#define _TUPLE_FILTER_X0(P,X) DEFER(CAT(_TUPLE_FILTER_Y,P(TUPLE_FIRST(X))))(P,X)
