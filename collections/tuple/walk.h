...
#define TUPLE_WALK(F,X) _TUPLE_WALK_C(F,X)
#define _TUPLE_WALK_C(F,X) _TUPLE_WALK_EVAL((DEFER(_TUPLE_WALK)(F COMMA_IF X UNWRAP X)))
...
#define _TUPLE_WALK_X1(F,X,...) CAT(_TUPLE_WALK_Y,IS_TUPLE(X))(F,X __VA_OPT__(,) __VA_ARGS__)
