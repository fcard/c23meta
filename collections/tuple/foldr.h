...
#define TUPLE_FOLDR(F,X,...) _TUPLE_FOLDR_EVAL(_TUPLE_FOLDR(F,TUPLE_IS_EMPTY(X),_TUPLE_FOLDR_P ## __VA_OPT__(1)(X),_TUPLE_FOLDR_INIT ## __VA_OPT__(1(__VA_ARGS__) IGNORE) (X)))
...
#define _TUPLE_FOLDR(F,N,X,R) DEFER(CAT(_TUPLE_FOLDR_X, N))(F,X,R)
