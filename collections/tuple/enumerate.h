...
#define TUPLE_ENUMERATE(X) TUPLE_REST(_TUPLE_ENUMERATE_EVAL((_TUPLE_ENUMERATE(TUPLE_IS_EMPTY(X),X,U32_0))))
...
#define _TUPLE_ENUMERATE(NX,X,N) DEFER(CAT(_TUPLE_ENUMERATE_X, NX))(X,N)
#define _TUPLE_ENUMERATE_X1(X,N)
#define _TUPLE_ENUMERATE_X0(X,N) ,(N,TUPLE_FIRST(X))_TUPLE_ENUMERATE_Y(TUPLE_REST(X),U32_ADD(N,U32_1))
