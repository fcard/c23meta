...
#define _TUPLE_SPLIT_AT_X0(R,X,N) CAT(_TUPLE_SPLIT_AT_Y,U32H_EQ(N,U32H_0))(R,X,N)
#define _TUPLE_SPLIT_AT_Y1(R,X,N) (R,TUPLE_REST(X))
#define _TUPLE_SPLIT_AT_Y0(R,X,N) _TUPLE_SPLIT_AT_Z(TUPLE_PUSH(R,TUPLE_FIRST(X)),TUPLE_REST(X),U32H_SUB(N,U32H_1))
