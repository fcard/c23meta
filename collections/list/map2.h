...
#define LIST_MAP2(F,X,Y) _LIST_MAP2_EVAL(_LIST_MAP2(F,LIST_IS_NIL(X),LIST_IS_NIL(Y),X,Y))
...
#define _LIST_MAP2(F,NX,NY,X,Y) DEFER(CAT(CAT(_LIST_MAP2_X,NX),NY))(F,X,Y)
