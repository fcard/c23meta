...
#define LIST_REMOVE(P,X) _LIST_REMOVE_EVAL(_LIST_REMOVE(P,LIST_IS_NIL(X),X))
...
#define _LIST_REMOVE(P,N,X) DEFER(CAT(_LIST_REMOVE_X, N))(P,X)
#define _LIST_REMOVE_X1(P,X) LIST_NIL
#define _LIST_REMOVE_X0(P,X) DEFER(CAT(_LIST_REMOVE_Y,P(LIST_FIRST(X))))(P,X)
