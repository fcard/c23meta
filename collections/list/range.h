...
#define _LIST_RANGE(X,Y,BY) CAT(_LIST_RANGE_X,I32_SIGN_BIT(BY))(X,Y,BY)
#define _LIST_RANGE_X0(X,Y,BY) _LIST_RANGE_P(X,Y,BY)
#define _LIST_RANGE_X1(X,Y,BY) _LIST_RANGE_N(X,Y,BY)

#define _LIST_RANGE_P(X,Y,BY) CAT(_LIST_RANGE_P_X, I32_GT(X,Y))(X,Y,BY)
...
#define _LIST_RANGE_N(X,Y,BY) CAT(_LIST_RANGE_N_X, I32_LT(X,Y))(X,Y,BY)
