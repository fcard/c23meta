...
#define _LIST_DROP_NTH_C(X,N)_LIST_DROP_NTH_EVAL(_LIST_DROP_NTH_PREAMBLE(U32_EQ(N,U32_0),X,N))
...
#define _LIST_DROP_NTH_X0(X,N0,N) CAT(_LIST_DROP_NTH_Y,U32_EQ(N,U32_1))(X,N0,N)
