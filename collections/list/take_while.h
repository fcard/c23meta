...
#define LIST_TAKE_WHILE(P,X) _LIST_TAKE_WHILE_EVAL(_LIST_TAKE_WHILE(P,LIST_IS_NIL(X),X))
...
#define _LIST_TAKE_WHILE(P,N,X) DEFER(CAT(_LIST_TAKE_WHILE_X, N))(P,X)
#define _LIST_TAKE_WHILE_X1(P,X) LIST_NIL
#define _LIST_TAKE_WHILE_X0(P,X) DEFER(CAT(_LIST_TAKE_WHILE_Y,P(LIST_FIRST(X))))(P,X)
