...
#define LIST_LENGTH(X) _LIST_LENGTH_C(X)
#define _LIST_LENGTH_C(X) _LIST_LENGTH_EVAL(_LIST_LENGTH(U32H_0,LIST_IS_NIL(X),X))
...
#define _LIST_LENGTH(R,N,X) CAT(_LIST_LENGTH_X, N)(R,X)
#define _LIST_LENGTH_X1(R,X) R
#define _LIST_LENGTH_X0(R,X) _LIST_LENGTH_Y(U32H_ADD(R,U32H_1),LIST_REST(X))
