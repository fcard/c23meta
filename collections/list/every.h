...
#define LIST_EVERY(P,X) _LIST_EVERY_C(P,X)
#define _LIST_EVERY_C(P,X) _LIST_EVERY_EVAL(_LIST_EVERY(P,LIST_IS_NIL(X),X))
...
#define _LIST_EVERY(P,N,X) CAT(_LIST_EVERY_X, N)(P,X)
#define _LIST_EVERY_X1(P,X) 1
#define _LIST_EVERY_X0(P,X) CAT(_LIST_EVERY_Y,P(LIST_FIRST(X)))(P,X)
