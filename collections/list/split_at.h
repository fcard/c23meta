...
#define LIST_SPLIT_AT(X,N) _LIST_SPLIT_AT_EVAL(_LIST_SPLIT_AT(LIST_NIL,LIST_IS_NIL(X),X,N))
...
#define _LIST_SPLIT_AT(R,NX,X,N) DEFER(CAT(_LIST_SPLIT_AT_X, NX))(R,X,N)
#define _LIST_SPLIT_AT_X1(R,X,N) LIST(LIST_REVERSE(R),LIST_NIL)
#define _LIST_SPLIT_AT_X0(R,X,N) DEFER(CAT(_LIST_SPLIT_AT_Y,U32_EQ(N,U32_0)))(R,X,N)
