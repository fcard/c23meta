...
#define LIST_LAST(X) _LIST_LAST_C(X)
#define _LIST_LAST_C(X) _LIST_LAST_EVAL(_LIST_LAST(LIST_NIL,LIST_IS_NIL(X),X))
...
#define _LIST_LAST(R,N,X) CAT(_LIST_LAST_X, N)(R,X)
