...
#define U32_PRINT(X) _U32_PRINT_CAT(_U32_PRINT_EVAL((_U32_PRINT(U32_GT(X,U32_9),X))))
...
#define _U32_PRINT(G,X) DEFER(CAT(_U32_PRINT_X,G))(U32_DIV(X,U32_10)) U32_PRINT_DIGIT(U32_REM(X,U32_10))
