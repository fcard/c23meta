...
#define _U32_SQRT_PREAMBLE(G,S) DEFER(CAT(_U32_SQRT_P,G))(S)
...
#define _U32_SQRT_Y(G,S,X0,X1) DEFER(CAT(_U32_SQRT_Z,G))(S,X0,X1)
#define _U32_SQRT_Z0(S,X0,X1) X0
#define _U32_SQRT_Z1(S,X0,X1) OBSTRUCT(_U32_SQRT_I)()(S,X1,_U32_SQRT_UPDATE(S,X1))
