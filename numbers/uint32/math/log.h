...
#define _U32_LOG_PREAMBLE(G,X,B) CAT(_U32_LOG_P,G)(X,B)
...
#define _U32_LOG_Y(G,X,R,B) CAT(_U32_LOG_Z,G)(X,R,B)
#define _U32_LOG_Z0(X,R,B) R
#define _U32_LOG_Z1(X,R,B) DEFER(_U32_LOG_I)()(U32_DIV(X,B),U32_ADD(R,U32_1),B)
