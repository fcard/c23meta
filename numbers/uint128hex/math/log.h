...
#define _U128H_LOG_PREAMBLE(G,X,B) DEFER(CAT(_U128H_LOG_P,G))(X,B)
...
#define _U128H_LOG_Y(G,X,R,B) DEFER(CAT(_U128H_LOG_Z,G))(X,R,B)
#define _U128H_LOG_Z0(X,R,B) R
#define _U128H_LOG_Z1(X,R,B) OBSTRUCT(_U128H_LOG_I)()(U128H_DIV(X,B),U128H_ADD(R,U128H_1),B)
