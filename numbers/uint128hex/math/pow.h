...
#define _U128H_POW_PREAMBLE(G,X,N) CAT(_U128H_POW_P,G)(X,N)
...
#define _U128H_POW_Y(G,X,Y,N) CAT(_U128H_POW_Z,G)(X,Y,N)
#define _U128H_POW_Z0(X,Y,N) U128H_MUL(X,Y)
#define _U128H_POW_Z1(X,Y,N) _U128H_POW_V(U128H_IS_ODD(N),X,Y,N)
#define _U128H_POW_V(G,X,Y,N) CAT(_U128H_POW_W,G)(X,Y,N)
#define _U128H_POW_W0(X,Y,N) DEFER(_U128H_POW_I)()(U128H_MUL(X,X),Y,U128H_RSH1(N))
#define _U128H_POW_W1(X,Y,N) DEFER(_U128H_POW_I)()(U128H_MUL(X,X),U128H_MUL(X,Y),U128H_RSH1(U128H_SUB(N,U128H_1)))
