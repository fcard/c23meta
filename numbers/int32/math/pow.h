...
#define I32_POW(X,N) I32_POW_EVAL(_I32_POW_PREAMBLE(I32_EQ(N,I32_0),X,N))
#define I32_POW_EVAL(X) I32_POW_EVAL1(X)
#define I32_POW_EVAL1(X) X

#define _I32_POW_PREAMBLE(G,X,N) DEFER(CAT(_I32_POW_P,G))(X,N)
#define _I32_POW_P0(X,N) _I32_POW(I32_CMP_SIGN(X,N),X,N)
#define _I32_POW_P1(X,N) I32_1

#define _I32_POW(S,X,N) DEFER(CAT(_I32_POW_X_,S))(X,N)
