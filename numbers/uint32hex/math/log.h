...
#define _U32H_LOG_PREAMBLE(G,X,B) CAT(_U32H_LOG_P,G)(X,B)
...
#define _U32H_LOG_Y(G,X,R,B) CAT(_U32H_LOG_Z,G)(X,R,B)
#define _U32H_LOG_Z0(X,R,B) R
#define _U32H_LOG_Z1(X,R,B) DEFER(_U32H_LOG_I)()(U32H_DIV(X,B),U32H_ADD(R,U32H_1),B)
