...
#define _U32H_POW_PREAMBLE(G,X,N) DEFER(CAT(_U32H_POW_P,G))(X,N)
...
#define _U32H_POW_Y(G,X,Y,N) DEFER(CAT(_U32H_POW_Z,G))(X,Y,N)
#define _U32H_POW_Z0(X,Y,N) U32H_MUL(X,Y)
#define _U32H_POW_Z1(X,Y,N) _U32H_POW_V(U32H_IS_ODD(N),X,Y,N)
#define _U32H_POW_V(G,X,Y,N) DEFER(CAT(_U32H_POW_W,G))(X,Y,N)
#define _U32H_POW_W0(X,Y,N) OBSTRUCT(_U32H_POW_I)()(U32H_MUL(X,X),Y,U32H_RSH1(N))
#define _U32H_POW_W1(X,Y,N) OBSTRUCT(_U32H_POW_I)()(U32H_MUL(X,X),U32H_MUL(X,Y),U32H_RSH1(U32H_SUB(N,U32H_1)))
