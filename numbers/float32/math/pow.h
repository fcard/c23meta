...
#define _FP32_POW_W0(X,NI,NF) FP32_MUL(FP32_POW_I(X, FP32_TO_U32(NI)), FP32_EXP(FP32_MUL(NF, FP32_LN(X))))
#define _FP32_POW_W1(X,NI,NF)\
  FP32_MUL(\
    FP32_SQRT(FP32_SQRT(X)),\
    FP32_MUL(\
      FP32_POW_I(X, FP32_TO_U32(NI)),\
      FP32_EXP(FP32_MUL(FP32_SUB(NF, FP32_1L4), FP32_LN(X)))))
...
#define _FP32_POW_Z0(SQX,X,NI,NF)\
  FP32_MUL(\
    ...
    FP32_MUL(\
      FP32_POW_I(X, FP32_TO_U32(NI)),\
      FP32_EXP(FP32_MUL(NF, FP32_LN(X)))))
