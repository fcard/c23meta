...
#define FP32_DIV(X,Y) FP32_DIV_EVAL(_FP32_DIV(FP32_EXPONENT(X),FP32_EXPONENT(Y), FP32_MANTISSA(X), FP32_MANTISSA(Y), FP32_CMP_SIGN(X,Y)))
...
#define _FP32_DIV_X(E,M,S) DEFER(CAT(_FP32_DIV_Y_,S))(E,M)
